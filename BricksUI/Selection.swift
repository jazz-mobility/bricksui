...
struct bsSelection: View {
    ...
    fileprivate func defaultStyle() -> some View {
        ...
        .padding()
        .background(RoundedRectangle(cornerRadius: 5).foregroundColor(focused ? bsColors.basic.opacity(0) : bsColors.basic.opacity(0.1)))
        .overlay(RoundedRectangle(cornerRadius: 5).stroke(focused ? bsColors.primary : bsColors.basic.opacity(0.4), lineWidth: 1))
    }
